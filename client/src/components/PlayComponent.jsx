...
const PlayComponent = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="mt-[24px] w-[400px] h-[80px] bg-[#e0dfdf] rounded-xl flex flex-col items-center justify-around py-[8px] px-[16px] text-[#818181] text-[14px] font-normal">
      ...
      <div className="rounded-lg overflow-hidden mx-[10%] mt-[24px]">
        <WebcamComponent />
      </div>
    </div>
  );
